...
namespace CafeAssets.Script.System.GameMapSystem
{
    ...
    /// </summary>
    public class PlaceTileUseCase : IGameScreenInputReceiver,IPlaceTileUseCase,ITileSelectReceiver
    {
       
        private IPlaceTileManager _placeTileManager;
        ...
        public PlaceTileUseCase(
            IPlaceTileManager placeTileManager)
        {
            _placeTileManager = placeTileManager;
        }
        /// <summary>
        /// タイル設置
        /// </summary>
